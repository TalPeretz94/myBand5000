...
public class Band implements Serializable {
	...
	public Band(int serialNumber, String name, int numOfFans, Integer formedYear, String origin, boolean split,
			String style) {
	...
	public boolean equals(Object o) {
		...
		if (o == null || getClass() != o.getClass())
			return false;
		Band band = (Band) o;
		return hasSplit() == band.hasSplit() && Objects.equals(getName(), band.getName())
